...
Adapters (e.g. `adapters/claude.py`) spawn this as a subprocess and speak MCP
...
_TOOLS: list[types.Tool] = [
    types.Tool(
        ...
        description=(
            ...
            "subsequent tool calls. `dsn` is a SQLAlchemy URL, e.g. "
            "`sqlite:///path/to.db`, `postgresql+psycopg://user:pw@host/db`."
        ),
        inputSchema={
            "type": "object",
